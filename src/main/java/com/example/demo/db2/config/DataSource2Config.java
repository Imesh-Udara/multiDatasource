...
@EnableJpaRepositories(entityManagerFactoryRef = "secondEntityMangerFactoryBean", basePackages = {"com.jts.multi.datasource.db2.repository"}, transactionManagerRef = "secondTransactionManager")
